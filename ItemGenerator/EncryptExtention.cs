...
public static class EncryptExtention
{
    ...
    public static string EncryptString(this string sourceString, string password)
    {
    ...
    public static string DecryptString(this string sourceString, string password)
    {
        //RijndaelManagedオブジェクトを作成
        System.Security.Cryptography.RijndaelManaged rijndael =
            new System.Security.Cryptography.RijndaelManaged();
    ...
    /// <summary>
    /// 暗号化された文字列を復号化する エンコード指定ver
    /// </summary>
    /// <param name="sourceString">暗号化された文字列</param>
    /// <param name="password">暗号化に使用したパスワード</param>
    /// <returns>復号化された文字列</returns>
    public static string DecryptString(this string sourceString, string password, System.Text.Encoding encode)
    {
        //RijndaelManagedオブジェクトを作成
        System.Security.Cryptography.RijndaelManaged rijndael =
            new System.Security.Cryptography.RijndaelManaged();
        ...
        //バイト型配列を文字列に戻して返す
        return encode.GetString(decBytes);
    }
